...
@pytest.mark.allow_call_model_methods
@pytest.mark.asyncio
async def test_stream_response_handles_snapshot_style_tool_call_chunks(monkeypatch) -> None:
    """Repeated snapshot-style chunks should not duplicate function name/args/call_id."""
    tool_call_delta1 = ChoiceDeltaToolCall(
        index=0,
        id="call_handoff_1",
        function=ChoiceDeltaToolCallFunction(
            name="handoff_to_recon",
