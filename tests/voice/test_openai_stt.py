...
try:
    from cerberus.agents.voice import OpenAISTTTranscriptionSession, StreamedAudioInput, STTModelSettings
    from cerberus.agents.voice.exceptions import STTWebsocketConnectionError
    from cerberus.agents.voice.models.openai_stt import EVENT_INACTIVITY_TIMEOUT
