...
def set_default_openai_key(key: str, use_for_tracing: bool = True) -> None:
    ...
    Args:
        ...
        use_for_tracing: Kept for API compatibility; has no effect. Tracing is handled
            locally and requires no API key.
    """
    _config.set_default_openai_key(key, use_for_tracing)


def set_default_openai_client(client: AsyncOpenAI, use_for_tracing: bool = True) -> None:
    """Set the default OpenAI client to use for LLM requests. If provided, this client
    will be used instead of the default OpenAI client.
