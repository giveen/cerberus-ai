...
<!-- NOT_IN_CERBERUS_TOOLSET: command_and_control (C2 framework not in registry — use run_ssh_command_with_credentials or generic_linux_command for session management) -->
<!-- NOT_IN_CERBERUS_TOOLSET: sshpass (not in registry — use run_ssh_command_with_credentials instead) -->