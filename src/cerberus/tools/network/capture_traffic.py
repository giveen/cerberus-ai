...
class CerebroCaptureTool:
    ...
    def _permitted_interfaces(self) -> set[str]:
        config_keys = [
            "CERBERUS_CAPTURE_PERMITTED_INTERFACES",
            "CERBERUS_PERMITTED_CAPTURE_INTERFACES",
        ...
        for key in config_keys:
            ...
            if value and value != "Not set":
                ...
                break
        if not raw:
            raw = os.getenv("CERBERUS_CAPTURE_PERMITTED_INTERFACES", "")
...
CAPTURE_TOOL = LazyToolProxy(CerebroCaptureTool)
