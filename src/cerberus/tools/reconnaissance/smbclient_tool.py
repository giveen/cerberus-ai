...
from cerberus.tools.validation import is_valid_host, sanitize_tool_output, validate_command_guardrails
...
class CerebroSMB:
    ...
    def __init__(self) -> None:
        ...
        self._tmp_dir = (self._workspace / ".cerberus" / "tmp").resolve()
        self._audit_log = (self._workspace / ".cerberus" / "audit" / "smb_courier.jsonl").resolve()
