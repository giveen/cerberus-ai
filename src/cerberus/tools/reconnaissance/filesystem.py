...
class CerebroFilesystemTool:
    ...
    def __init__(self) -> None:
        ...
        self._audit_path = (self._workspace / ".cerberus" / "audit" / "filesystem_audit.jsonl").resolve()
    ...
    def _path_redactions(self) -> List[tuple[str, str]]:
        values = [
            ...
            (os.getenv("CERBERUS_PRIVATE_ROOT", ""), "[PRIVATE_ROOT]"),
            (os.getenv("CERBERUS_AGENT_WRITE_ROOT", ""), "[PRIVATE_ROOT]"),
        ]
...
FILESYSTEM_TOOL = LazyToolProxy(CerebroFilesystemTool)
