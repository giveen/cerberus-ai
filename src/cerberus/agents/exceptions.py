...
class AgentsException(Exception):
    """Base class for all exceptions in the Cerberus agents."""
...
class UserError(AgentsException):
    """Exception raised when the user makes an error using Cerberus."""
...
class AgentLoopError(AgentsException):
    """Raised when circuit-breaker logic detects a hopeless execution loop."""
