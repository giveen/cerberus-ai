...
from cerberus.tools.runners.local import PathGuard as LocalPathGuard
...
async def cpbe_input_guardrail(
    ...
    if os.getenv("CERBERUS_GUARDRAILS", "true").lower() == "false":
