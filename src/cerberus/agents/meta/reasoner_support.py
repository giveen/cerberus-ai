...
try:
    from cerberus.agents.usecase import MissionProfile  # type: ignore[attr-defined]
    _COSE_AVAILABLE = True
except Exception:  # pragma: no cover
    _COSE_AVAILABLE = False
    MissionProfile = None  # type: ignore[assignment]

_CCLB_LOGGER = logging.getLogger("cerberus.cclb")
...
def create_reasoner_agent(
    ...
    """
    if model is None:
        model = os.getenv("CERBERUS_SUPPORT_MODEL", "o3-mini")
