...
from cai.tools.validation import is_valid_target, sanitize_tool_output
...
class CerebroNmapTool:
    ...
    def __init__(self) -> None:
        ...
        self._audit_log = (self._workspace / ".cai" / "audit" / "nmap_scans.jsonl").resolve()
