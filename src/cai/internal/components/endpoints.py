...
try:
    from cai.agents.meta.reasoner_support import (
...
_CHCD_LOGGER = logging.getLogger("cai.chcd")
...
class CerebroEndpointManager:
    ...
    async def __aenter__(self) -> "CerebroEndpointManager":
        await self.start()
        return self
...
cerebro_endpoint_manager = CerebroEndpointManager()
