...
Model: {get_compact_model() or os.environ.get("CEREBRO_MODEL", "gpt-4")}
...
"""
            ...
            os.environ['CEREBRO_MEMORY'] = 'true'
...
"""
    ...
    async def _ai_summarize_history(self, agent_name: Optional[str] = None) -> Optional[str]:
        ...
        model_name = get_compact_model() or os.environ.get("CEREBRO_MODEL", "cerebro1")
