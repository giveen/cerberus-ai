...
from cai.repl.commands.model import get_predefined_model_names  # type: ignore[import-untyped]
...
class _ToolSource:
    ...
    def names(cls) -> List[str]:
        ...
        result: List[str] = []
        try:
            from cai.sdk.agents.simple_agent_manager import AGENT_MANAGER  # type: ignore[import-untyped]
...
class _ModelSource:
    ...
    def _do_refresh(self) -> None:
        ...
        try:
            from cai.util import get_ollama_api_base  # type: ignore[import-untyped]
...
def _mcp_server_names() -> List[str]:
    try:
        from cai.repl.commands.mcp import _GLOBAL_MCP_SERVERS  # type: ignore[import-untyped]
...
class FrameworkCompleter(Completer):
    ...
    Typical usage::
        ...
        from cai.repl.commands.completer import FrameworkCompleter
