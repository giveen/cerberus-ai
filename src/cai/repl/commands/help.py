...
from cai.repl.commands.base import COMMAND_ALIASES, COMMANDS, Command, FrameworkCommand, register_command
...
class DocGenerator:
    ...
    def build_examples(name: str) -> List[str]:
        ...
        specific = {
            ...
            "config": ["/config list", "/config set CEREBRO_MODEL o4-mini"],
