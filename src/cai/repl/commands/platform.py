...
class SystemAuditor:
    ...
    def __init__(self, *, memory: MemoryManager, workspace_root: Path) -> None:
        ...
        self._audit_path = self._workspace_root / ".cai" / "audit" / "platform_audit.jsonl"
    ...
    def _allow_fingerprint(self) -> bool:
        key = "CEREBRO_PLATFORM_ALLOW_FINGERPRINT"
...
class PlatformCommand(FrameworkCommand):
    ...
    def help(self) -> str:
        return (
            ...
            "Privacy: host identifiers remain redacted unless CEREBRO_PLATFORM_ALLOW_FINGERPRINT=true"
        )
