...
class FlushCommand(Command):
    ...
    def handle_all(self, args: Optional[List[str]] = None) -> bool:
        del args
        from cai.sdk.agents.models.openai_chatcompletions import clear_all_histories, get_all_agent_histories
    ...
    def handle_agent(self, args: Optional[List[str]] = None) -> bool:
        from cai.sdk.agents.models.openai_chatcompletions import clear_agent_history, get_agent_message_history
