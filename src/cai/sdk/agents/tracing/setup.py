...
class SynchronousMultiTracingProcessor(TracingProcessor):
    ...
    def add_tracing_processor(self, tracing_processor: TracingProcessor):
        ...
        with self._lock:
            ...
            self._debug_logger.write(
                channel="tracing",
                message="processor_added",
                payload={"processor": repr(tracing_processor)},
            )
    ...
    def set_processors(self, processors: list[TracingProcessor]):
        ...
        with self._lock:
            ...
            self._debug_logger.write(
                channel="tracing",
                message="processors_set",
                payload={"count": len(processors)},
            )
...
class TraceProvider:
    ...
    def register_processor(self, processor: TracingProcessor):
        ...
        self._debug_logger.write(
            channel="tracing",
            message="register_processor",
            payload={"processor": repr(processor)},
        )
    ...
    def set_disabled(self, disabled: bool) -> None:
        ...
        self._debug_logger.write(
            channel="tracing",
            message="set_disabled",
            payload={"disabled": disabled, "stack": stack},
        )
