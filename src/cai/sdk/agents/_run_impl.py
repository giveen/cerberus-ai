...
def truncate_output(output: Any, max_length: int = 0) -> str:
    ...
    """
    configured_max = int(os.getenv("CEREBRO_TOOL_OUTPUT_MODEL_MAX_CHARS", "6000"))
    ...
    head = max(500, min(limit // 2, int(os.getenv("CEREBRO_TOOL_OUTPUT_MODEL_HEAD_CHARS", "2500"))))
    tail = max(500, min(limit - head, int(os.getenv("CEREBRO_TOOL_OUTPUT_MODEL_TAIL_CHARS", "2500"))))
