...
from cai.sdk.agents import Agent, FunctionTool, OpenAIChatCompletionsModel, function_tool
...
class CerebroAgentFactory:
    ...
    def _clone_runtime_agent(
        ...
        *,
        ...
        model_name = (
            model_override
            or os.getenv(f"CEREBRO_{role.upper()}_MODEL")
            or os.getenv(f"CAI_{role.upper()}_MODEL")
            or os.getenv("CEREBRO_MODEL")
            or os.getenv("CAI_MODEL")
            or "cerebro1"
        )
    ...
    def _compose_metadata(
        ...
        *,
        ...
        payload: Dict[str, Any] = {
            ...
            "target_ip": target_ip or os.getenv("CEREBRO_TARGET_IP") or "unknown",
            "project_id": project_id or os.getenv("CEREBRO_PROJECT_ID") or "unknown",
    ...
    def _fallback_generic(
        ...
        *,
        ...
        model_name = model_override or os.getenv("CEREBRO_MODEL", "cerebro1")
        api_key = os.getenv("OPENAI_API_KEY", "sk-placeholder-key-for-local-models")
