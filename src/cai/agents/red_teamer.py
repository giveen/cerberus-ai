...
from cai.agents.one_tool import CerebroAtomicRunner, ExtractionRequest
...
from cai.tools.runners.local import PathGuard
...
class CerebroFieldAgent:
    ...
    async def _exfiltrate_loot(self, *, destinations: List[str]) -> Dict[str, Any]:
        ...
        from cai.agents.mail import cerebro_secure_comm_agent  # noqa: PLC0415
...
load_dotenv()
_model_name = os.getenv("CEREBRO_MODEL", "cerebro1")
