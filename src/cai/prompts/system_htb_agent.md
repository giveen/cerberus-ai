...
<!-- NOT_IN_CEREBRO_TOOLSET: flag_discriminator (not in registry — use grep or strings_command with HTB flag pattern) -->
<!-- NOT_IN_CEREBRO_TOOLSET: ffuf (not a dedicated tool — invoke via generic_linux_command("ffuf", ...)) -->