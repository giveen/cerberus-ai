...
- [x] commit-and-push-changes: Stage all current changes, create commit, and push to origin/main 🔴
- [x] rebuild-and-restart-docker: Rebuild Docker images and relaunch stack, then verify running services 🔴
</todos>
